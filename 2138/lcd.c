 ...
 *****************************************************************************/
#define LCD_CMD_SWRESET   0x01 //clear all the contents of the DDRAM and also clear the lcd removes all the text from the screen
#define LCD_CMD_BSTRON    0x03 //
#define LCD_CMD_SLEEPIN   0x10 //moves cursor one step left or move cursor on step a head to left when ever new character is displayed  on the screen
